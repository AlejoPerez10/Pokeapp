        ...
        <header className='flex fixed justify-around items-center w-full h-14 md:h-20 bg-blue-800 z-20'>
            ...
            <aside className='flex relative items-center m-3 mr-7'>
                <input type="search" placeholder="Buscar..." 
                    className="rounded-l-full px-5 py-1 md:py-3 w-32 md:w-48 focus:w-44 md:focus:w-72 focus:outline focus:outline-2 transition-all duration-200 outline-none bg-yellow-600 text-white placeholder-[white]"
                />
